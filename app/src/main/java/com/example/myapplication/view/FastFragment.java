...
import com.example.myapplication.controller.FastController;
...
public class FastFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        FastController controller = new FastController(this);
        controller.onStart();
        return view;
    }
    ...
    public void showList(List<Brawler> input){
        List<Brawler> listFastBrawlers = new ArrayList<>();
        for (Brawler brawler : input){
            if (brawler.isFast()){
                listFastBrawlers.add(brawler);
            }
        }
        ...
        // define an adapter
        mAdapter = new MyAdapter(listFastBrawlers, getContext());
